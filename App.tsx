        ...
        <div className="mt-20 max-w-5xl mx-auto rounded-[30px] overflow-hidden bg-[#f5f5f7] border border-[#d2d2d7]">
           <div className="aspect-[21/9] flex items-center justify-center relative bg-gradient-to-tr from-[#f5f5f7] to-white">
              <div className="text-center">
                <span className="text-[100px] opacity-10 font-black tracking-tighter">GLOBAL EXPANSION</span>
      ...
      <section id="persona" className="py-24 apple-bg-grey px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            <div className="md:col-span-8 bento-card p-12 flex flex-col justify-end min-h-[400px] relative overflow-hidden">
               <div className="relative z-10">
                <h3 className="text-4xl font-bold mb-4">技术开发者</h3>
                <p className="text-xl text-[#86868b] max-w-md font-medium">利用技术优势，结合 AI 与 SEO 建立自动化流量资产，在全球市场实现被动收入。</p>
               </div>
               <div className="absolute top-12 right-12 text-7xl opacity-10 font-mono">CODE</div>
            </div>
            <div className="md:col-span-4 bento-card p-12 bg-white border border-[#d2d2d7]">
              <h3 className="text-2xl font-bold mb-4">SEO 站长</h3>
      ...
      <section id="syllabus" className="py-24 px-6 bg-white">
        <div className="max-w-4xl mx-auto">
          <SectionHeader 
            tag="Curriculum"
            title="精心打磨的大纲。" 
            subtitle="每一个模块都直指变现，每一处细节都来自真实踩坑。"
          />
      ...
      <section id="pricing" className="py-24 apple-bg-grey px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-16 text-center">
             <p className="text-[#86868b] text-sm font-medium">需要大客户或企业定制方案？ <a href="#" className="apple-link">联系我们团队</a></p>
          </div>
        </div>
      </section>
